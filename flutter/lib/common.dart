...
class MyTheme {
  ...
  static const Color accent50 = Color(0x77FF4D4D);
  static const Color accent80 = Color(0xAAFF4D4D);
  ...
  static const Color button = Color(0xFFE63E3E);
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://sicherdesk.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
