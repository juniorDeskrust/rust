...
def build_flutter_dmg(version, features):
    ...
    system2('cp -rf ../target/release/service ./build/macos/Build/Products/Release/SicherDesk.app/Contents/MacOS/')
    '''
    system2(
        "create-dmg --volname \"SicherDesk Installer\" --window-pos 200 120 --window-size 800 400 --icon-size 100 --app-drop-link 600 185 --icon SicherDesk.app 200 190 --hide-extension SicherDesk.app sicherdesk.dmg ./build/macos/Build/Products/Release/SicherDesk.app")
...
def build_flutter_windows(version, features, skip_portable_pack):
    ...
    system2(
        f'python3 ./generate.py -f ../../{flutter_build_dir_2} -o . -e ../../{flutter_build_dir_2}/SicherDesk.exe')
    os.chdir('../..')
